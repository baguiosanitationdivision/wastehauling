...
function submitEntry() {
  ...
  pendingPayload = { date, inspector: insp, inspection: treat, weight: parseFloat(weight), dhc };

  document.getElementById('confirmDetails').innerHTML = `
    <div style="display:flex;justify-content:space-between;padding:3px 0;"><span style="color:var(--muted);">Date</span><span>${date}</span></div>
    <div style="display:flex;justify-content:space-between;padding:3px 0;"><span style="color:var(--muted);">Inspector</span><span>${insp}</span></div>
    <div style="display:flex;justify-content:space-between;padding:3px 0;"><span style="color:var(--muted);">Inspection</span><span>${treat}</span></div>
    <div style="display:flex;justify-content:space-between;padding:3px 0;"><span style="color:var(--muted);">Weight</span><span>${parseFloat(weight).toFixed(2)} kg</span></div>
    <div style="display:flex;justify-content:space-between;padding:3px 0;"><span style="color:var(--muted);">Health center</span><span>${dhc}</span></div>
  `;
